...
public class EvaluationService {
	...
	public String acronym(String phrase) {
		 ...
		 phrase="Portable Network Grapics";
...
//		System.out.println("HERe");
	         ...
	         for (int i = 0; i <string.length(); i++) {
	             if (string.charAt(i) == 'A' || string.charAt(i) == 'E' ||
	                  ...
	                  string.charAt(i) == 'O' || string.charAt(i) == 'U' ||
	                     string.charAt(i) == 'L' || string.charAt(i) == 'N' ||
	                  string.charAt(i) == 'R' || string.charAt(i) == 'S' ||
	                    string.charAt(i) == 'T') {

	                 lettersMap.put(string.charAt(i), 1);
	                 lettersMap.put(string.toLowerCase().charAt(i), 1);
	             }
	             if (string.charAt(i) == 'D' || string.charAt(i) == 'G') {
	                 lettersMap.put(string.charAt(i), 2);
	                 lettersMap.put(string.toLowerCase().charAt(i), 2);
	             }

	             if (string.charAt(i) == 'B' ||string.charAt(i) == 'C' ||
	                     string.charAt(i) == 'M' || string.charAt(i) == 'P') {
	                 lettersMap.put(string.charAt(i), 3);
	                 lettersMap.put(string.toLowerCase().charAt(i), 3);
	             }
		
	             if (string.charAt(i) == 'F' || string.charAt(i) == 'H' ||
	                     string.charAt(i) == 'V' || string.charAt(i) == 'W' ||
	                     string.charAt(i) == 'Y') {
	                 lettersMap.put(string.charAt(i), 4);
	                 lettersMap.put(string.toLowerCase().charAt(i), 4);
	             }

	             if (string.charAt(i) == 'K') {
	                 lettersMap.put(string.charAt(i), 5);
	                 lettersMap.put(string.toLowerCase().charAt(i), 5);
	             }

	             if (string.charAt(i) == 'J' || string.charAt(i) == 'X') {
	                 lettersMap.put(string.charAt(i), 8);
	                 lettersMap.put(string.toLowerCase().charAt(i), 8);
	             }

	             if (string.charAt(i) == 'Q' || string.charAt(i) == 'Z') {
	                 lettersMap.put(string.charAt(i), 10);
	                 lettersMap.put(string.toLowerCase().charAt(i), 10);
	             }
	...
	public String cleanPhoneNumber(String string) {
		// TODO Write an implementation for this method declaration
//		string="+1 (613)-995-0253 613-995-0253 1 613 995 0253 613.995.0253";
//		string.replaceAll("[/()-+.]","");
//		System.out.println(cleanPhoneNumber(string));
		String number = "";
		for(int i=0; i<string.length(); i++) {
	...
	int i;	
	 for( i=0;i<string.length();i++)
		...
		string=string.substring(i)+string.substring(0, i)+"ay";
...
//		return string;
	...
	public boolean isArmstrongNumber(int input) {
		...
		if(temp==input)
			System.out.printf("\n is a amstrong number=%d",input);
		else
			System.out.printf("\n not a amstrong number=%d",input);
	...
	static class RotationalCipher {
		...
		public String rotate(String string) {
			// TODO Write an implementation for this method declaration
			 ...
			 string="The quick brown box jumps over the lazy dog";
			 key=4;
			 for (int i=0; i<string.length(); i++) 
		        { 
